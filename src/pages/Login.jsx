...
const API = 'https://gvmynnufzofwvvgwsekg.supabase.co/functions/v1/api';
const KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imd2bXlubnVmem9md3Z2Z3dzZWtnIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzM2MDY4MjUsImV4cCI6MjA4OTE4MjgyNX0.jwLtjOqOwEfhaAgXaGX7O63VL3cVPZNpN-pbKZ1AOS8';
      ...
      <div className="login-box">
        ...
        <form onSubmit={submit}>
          <div className="fg">
            ...
            <input type="email" value={email} onChange={e=>setEmail(e.target.value)} placeholder="hrithikagarwal01@gmail.com" required autoFocus/>
          </div>
          <div className="fg">
...
```
cd C:\Users\hrith\Downloads\avenaa-onboarding-final\avenaa_final\admin-panel
```
```
git add .
```
```
git commit -m "supabase direct"
```
```
git push